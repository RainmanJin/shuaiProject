...
/*  function dsBtn(){
  ...
  dsPerson();
  // 首页焦点图，等比例缩放
  var focusRatio = 1.75824176;
  function focusRisize(){
    var wWidth = $(window).width();
    $("#slider,.swipe-wrap,.focus-wrap,.focus-image").css("height",wWidth/focusRatio);
  }
  focusRisize();
  ...
  */
  ...
  $("#sign-checkbox").bind("click",function(){
    if($(this).hasClass("checkbox1") == true){
      $(this).removeClass("checkbox1").andSelf().addClass("checkbox0");
    }else{
      $(this).removeClass("checkbox0").andSelf().addClass("checkbox1");
    }
  })
